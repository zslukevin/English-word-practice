...
if __name__ == '__main__':
    ...
    print(db.execute("select id, 单元, 单词, 类型, 解析 from words"))
    print(db.execute("select * from words", result_dict=False))
    print(db.execute("select * from words"))
